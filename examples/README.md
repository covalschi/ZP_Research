...
| [`zone-protocol/`](zone-protocol/) | You want the full Zone Protocol server set — 7 factions, 7 trees, faction devices for every faction and 1087 rarity-tiered rules, all priced in lab points only |
